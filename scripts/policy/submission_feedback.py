...
body = 'The policy URL could not be registered.\n\n' + '\n'.join('> ' + line for line in reason.splitlines()) + '\n\nCheck the URL and package, then edit the issue to retry; reopening it is an alternative. Published packages should contain a pinned ONNX artifact and, when runtime facts are claimed, a machine-readable manifest.'
