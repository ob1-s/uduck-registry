...
body = 'The policy URL could not be registered.\n\n' + '\n'.join('> ' + line for line in reason.splitlines()) + '\n\nCheck the URL and package, edit the issue, then close and reopen it to retry. Published packages should contain a pinned ONNX artifact and, when runtime facts are claimed, a machine-readable manifest.'
